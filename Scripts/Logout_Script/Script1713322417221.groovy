...
//WebUI.focus(findTestObject('Object Repository/Login_Logout/Page_Home/a_Logout'))
//WebUI.delay(2)
//WebUI.click(findTestObject('Object Repository/Login_Logout/Page_Home/a_Logout'))
//WebUI.delay(5)
//WebUI.closeBrowser()
